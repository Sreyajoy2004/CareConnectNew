      ...
      `}>
        ...
        <div className="hidden lg:block p-6 border-b border-blue-700">
          <div className="flex items-center space-x-3">
            ...
            <div className="flex-1 min-w-0">
              <h3 className="text-white font-semibold truncate">{user?.name || 'Admin User'}</h3>
              <p className="text-blue-200 text-sm truncate">Administrator</p>
            </div>
          </div>
        </div>
        ...
        <div className="p-4 border-t border-blue-700">
          <div className="text-center">
            <p className="text-blue-200/50 text-xs">CareConnect Admin v1.0</p>
          </div>
        </div>
      </div>
