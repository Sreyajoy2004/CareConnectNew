// src/components/careprovider/CareProviderSidebar.jsx
import React, { useState, useEffect } from 'react';
import { Link, useLocation, useNavigate } from 'react-router-dom';
import { useAppContext } from '../../context/AppContext';

const CareProviderSidebar = () => {
  ...
  return (
    <>
      ...
      `}>
        ...
        {/* Mobile Header with Close Button - Simplified */}
        ...
        {/* Desktop User Info Section - Starting point of sidebar */}
        <div className="hidden lg:block p-6 border-b border-blue-700">
          <div className="flex items-center space-x-3">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-blue-200 text-sm truncate">Caregiver</p>
            </div>
          </div>
        </div>

        {/* Navigation Menu with Dark Styling */}
